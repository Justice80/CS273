...
protected:
	...
	*/
	std::string get_fees()
	{
		...
		charge = customer->getCheckCharge();
		overdraft = customer->getOverDraftPenalty();
...
public:
	...
	*/
	virtual std::string to_string() {
		...
		ss << "Phone: " << customer->getPhoneNumber() << std::endl;
...
public:
	SavingsAccount(Customer * cust, int acctNum) : Account(cust, acctNum) {}
	...
	void add_interest() { customer->getSavingsInterest(); }
...
public:
	CheckingAccount(Customer * cust, int acctNum) : Account(cust, acctNum) {}
	...
	void add_interest() { customer->getCheckingInterest(); }
