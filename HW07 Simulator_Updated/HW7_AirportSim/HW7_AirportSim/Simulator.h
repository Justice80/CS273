...
public:
	...
	void show_stats()
	{
		...
		std::cout << "Total wait time for all planes in arrival queue: " << landing_queue->get_total_wait() << " mins" << std::endl;
		// FIXME: Calculate and display the average wait time for the landing queue
		std::cout << "Average wait time in the arrival queue: " << (landing_queue->get_total_wait() / landing_queue->get_num_served()) << " mins";

		std::cout << std::endl;
		std::cout << "Number of planes served in the departure queue: " << departure_queue->get_num_served() << std::endl;
		std::cout << "Total wait time for all planes in departure queue: " << departure_queue->get_total_wait() << " mins" << std::endl;
		// FIXME: Calculate and display the average wait time for the departure queue
		std::cout << "Average wait time in the departure queue: " << (departure_queue->get_total_wait() / departure_queue->get_num_served()) << " mins";
